                    ...
                    >
                      {row.map((letter, letterIdx) => (
                        <div
                          ...
                          className={`h-full aspect-square flex justify-center items-center text-3xl font-semibold bg-[#9EB7E5]/90 rounded-2xl cursor-pointer hover:bg-[#9EB7E5] transition-colors ease-linear duration-300
              ...
              <div className="w-full h-full rounded-2xl flex justify-center items-center flex-row flex-wrap">
                {[...Array(20)].map((_, i) => (
                  <div
                    ...
                    className={`w-[10%] h-[30%] flex justify-center items-center text-2xl cursor-pointer
                      ${i != 9 && i != 19 ? "border-r-2" : ""}
                      ${
